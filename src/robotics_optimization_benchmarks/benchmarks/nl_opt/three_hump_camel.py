"""Define the three hump camel optimization benchmark."""
import jax
...
class ThreeHumpCamel(Benchmark):
    """Define a benchmark for the three hump camel function.
    ...
    def evaluate_solution(self, solution: DecisionVariable) -> Float[Array, ""]:
        ...
        return jnp.sum(2 * x**2 - 1.05 * x**4 + x**6 / 6 + x * y + y**2)
