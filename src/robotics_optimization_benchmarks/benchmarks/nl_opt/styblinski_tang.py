"""Define the StyblinskiTang optimization benchmark."""
import jax
...
class StyblinskiTang(Benchmark):
    """Define a benchmark for the StyblinskiTang function.

    Mimizes the function defined here:
    https://www.sfu.ca/~ssurjano/stybtang.html

    This function has a global minimum at f = -39.16599 * dimension

    Attributes:
        dimension: The dimension of the problem.
    """

    _name: str = "styblinski_tang"
    ...
    def evaluate_solution(self, solution: DecisionVariable) -> Float[Array, ""]:
        ...
        """
        return 0.5 * jnp.sum(solution**4 - 16 * solution**2 + 5 * solution)
